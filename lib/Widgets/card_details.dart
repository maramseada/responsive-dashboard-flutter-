...
class CardDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
ClipOval(child: Image.asset(info.image),),
          SizedBox(width: getResponsiveFontSize(context, fontSize: 10),),
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(info.title, style: AppStyles.style60016(context: context),),
              Text(info.subTitle, style: AppStyles.style40012(context: context),),
            ],
          )
        ],
      ),
